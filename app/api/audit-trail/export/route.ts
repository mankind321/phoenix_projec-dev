...
/* ============================================================
   🔐 HEADER-BASED RLS CLIENT (service role + headers)
============================================================ */
...
export async function GET(req: Request) {
  try {
    ...
    /* -------------------------------------------------------
      🔽 Table Rows (with WRAP + proper overflow check)
    -------------------------------------------------------- */
    logs.forEach((log, idx) => {
      ...
      // If row would overflow → add page BEFORE rendering
